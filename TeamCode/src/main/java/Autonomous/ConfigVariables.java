...
public class ConfigVariables {
    ...
    public static double DIST_STONE_THREE_LEFT = 22;
    public static double DIST_STONE_THREE_RIGHT = 19;

    public static double STONE_FOUR = 28.5;
    public static double STONE_FIVE = 27;
    public static double STONE_SIX = 19.5;

    public static double DIST_STONE_FOUR = 17.5;
    public static double DIST_STONE_FIVE = 7;
